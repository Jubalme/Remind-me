...
const Sidebar = () => (
  <div className="w-64 bg-blue-800 text-white flex flex-col">
    ...
    <nav className="flex-1 px-4">
      <ul>
        <li className="py-2"><a href="#" className="hover:text-blue-300">Dashboard</a></li>
        <li className="py-2"><a href="#" className="hover:text-blue-300">Tasks</a></li>
        <li className="py-2"><a href="#" className="hover:text-blue-300">Settings</a></li>
      </ul>
    </nav>
  </div>
);
